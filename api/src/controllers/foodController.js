...
const getApiInfo = async () => {
    try {
        const info = await axios.get('https://api.spoonacular.com/recipes/complexSearch?apiKey=25646de026df4850a22b07c7eebf31e2&addRecipeInformation=true&number=100')
